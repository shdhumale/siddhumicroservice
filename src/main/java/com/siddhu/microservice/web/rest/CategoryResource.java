package com.siddhu.microservice.web.rest;
...
import com.siddhu.microservice.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.siddhu.microservice.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    private static final String ENTITY_NAME = "siddhumicroserviceCategory";
